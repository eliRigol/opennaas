package org.opennaas.extensions.router.activator;
...
public class Activator extends AbstractActivator implements BundleActivator {
	...
	/**
	 * Get the GreTunnel action set service
	 * 
	 * @param name
	 * @param version
	 * @return IActionSet
	...
	/**
	 * Get the OSPF action set service
	 * 
	 * @param name
	 * @param version
	 * @return IActionSet
	...
	/**
	 * Get the Static Route action set service
	 * 
	 * @param name
	 * @param version
	 * @return IActionSet
